...
//*************Practica 10: Osito Gigante Volador******************//
...
void InitGL(GLvoid)     // Inicializamos parametros
{
	...
	//Carga de Figuras
	kit._3dsLoad("Osito.3ds");
	//kit.VertexNormals();

	objCamera.Position_Camera(15, 2.5f, 13, 10, 2.5f, 10, 0, 1, 0);
...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	glRotatef(girarkit, 0, 1, 0);										//Pongo aquí la carroceria del carro			Glrender mandar a dibujar lo que ya cargamos
	...
	pintaTexto(-16, 10.5, -20, (void *)font, "Gustaf Bermudez Sotelito");
	glColor3f(1.0, 1.0, 1.0);
	glEnable(GL_LIGHTING);
...
int main(int argc, char** argv)   // Main Function
{
	...
	glutCreateWindow("Practicashki 10 Osito Volador flotante gigante"); // Nombre de la Ventana
